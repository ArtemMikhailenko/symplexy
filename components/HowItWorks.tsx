...
export default function HowItWorks() {
  ...
  return (
    ...
    >
      ...
      <div className="lg:hidden relative w-screen h-[515px] md:h-[600px] -mb-16 md:-mb-20 left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] -z-10">
      ...
      <div className="relative max-w-[1920px] mx-auto px-4 md:px-12 lg:px-[342px] z-20">
        ...
        <div className="flex items-start gap-8 lg:gap-12 lg:justify-end relative z-20">
          ...
          <div className="lg:hidden relative flex flex-col items-center pt-2 ml-6 md:ml-0 z-20">
            {/* Vertical Line */}
          ...
          {/* Steps Content */}
          <div className="flex flex-col gap-12 lg:gap-16 pt-0 flex-1 lg:flex-initial relative z-20">
            {steps.map((step, index) => (
              <div
                key={step.id}
                className="flex flex-col gap-4 lg:gap-6 relative z-20"
                style={{
                  minHeight: step.hasButton ? "196px" : index === 1 || index === 3 ? "108px" : "84px",
                }}
              >
                {/* Text Content */}
                <div className="flex flex-col gap-2 lg:gap-3 relative z-20">
        ...
        <div className="hidden lg:flex justify-center mt-20">
          <button className="w-[277px] h-14 px-6 py-4 bg-[#5289ff] text-white rounded-[100px] hover:bg-[#2d4b8c] transition-all duration-300 flex items-center justify-center gap-2 shadow-lg hover:shadow-xl">
